                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center hover:bg-gray-50">
                                    ...
                                    <td class="px-2 py-1 border border-gray-300"><?php echo e($person->BirthDate); ?></td>
                                    <td class="px-2 py-1 border border-gray-300"
                                        style="min-width: 400px; max-width: 600px;"><?php echo e($person->MedicalRecord); ?></td>
                                </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\bilag\Herd\smilepro\resources\views/persons/index.blade.php ENDPATH**/ ?>